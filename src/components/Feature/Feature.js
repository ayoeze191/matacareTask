...
const Feature = () => {
    return (
        <div className="w-full py-10 px-5 md:px-10 relative pb-20">
            <div className="  mx-auto  flex justify-center w-full  h-fit features">
             <div className="flex flex-col w-4/5 items-center h-fit relative -mt-24  rounded-lg p-5 bg-white shadow-md feature">
                <div className="md:mr-12">
                    <h1 className="text-4xl text-waiting_list font-bold text-center">10</h1>
                    <p className="text-center text-xl">Family Members</p>
                </div>
                <div className="md:mr-12">
                <h1 className="text-waiting_list text-4xl font-bold text-center">3000+</h1>
                    <p className="text-center text-xl">Users</p>
                </div>
                <div className="md:mr-12">
                <h1 className="text-waiting_list text-4xl font-bold text-center">2021</h1>
                    <p className="text-center text-xl">Year Founded</p>
                </div>
                <div className="md:mr-12">
                <h1 className="text-waiting_list text-4xl font-bold text-center">1</h1>
                    <p className="text-center text-xl">Product(s)</p>
                </div>
                </div>
                </div>
                <div className="flex flex-col mt-20">
                    <div className="w-fit mx-auto">
                <h1 className="text-3xl font-bold text-brand_secondary after:block after:content-[''] after:bg-black after:h-1 after:mx-auto after:w-10 after:mt-1 mb-20">Features</h1>
                </div>
